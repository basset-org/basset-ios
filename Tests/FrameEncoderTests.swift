...
struct EncoderTests {
    ...
    /// The leading byte says which payload this is, rather than a decoder
    /// inferring it from a zero entity id — an inference that breaks the day an
    /// entity id crosses 256 and its low byte reads as zero.
